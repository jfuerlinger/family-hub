...
const mainNav: NavItem[] = [
  ...
  { to: '/solutions', label: 'Lösungen', icon: 'mindmap' },
]
    ...
    <aside class="sidebar" :class="{ 'sidebar--open': isMobileMenuOpen }" :id="mobileNavigationId">
      ...
      <nav class="nav">
        ...
        >
          ...
          <!-- Mindmap icon -->
          <svg v-else-if="item.icon === 'mindmap'" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <circle cx="5" cy="12" r="2"/><circle cx="19" cy="5" r="2"/><circle cx="19" cy="19" r="2"/><circle cx="11" cy="12" r="2"/>
            <line x1="7" y1="12" x2="9" y2="12"/><line x1="13" y1="11" x2="17" y2="6"/><line x1="13" y1="13" x2="17" y2="18"/>
          </svg>
          {{ item.label }}
        </RouterLink>
      </nav>
